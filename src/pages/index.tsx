...
const TERMS: Term[] = [
  {
    ...
    body: 'Від блок-схеми до консольного застосунку на ООП. Сім лабораторних робіт, які завершуються невеликим власним проєктом.',
  ...
  },
  {
    ...
    body: 'Графічний інтерфейс на WPF, робота з даними та мережею. Тринадцять лабораторних робіт із наголосом на бізнес-логіці.',
    ...
    <header className={styles.hero}>
      <div className="container">
        <div className={styles.heroInner}>
          <p className={styles.heroMeta}>35 тем · 20 лабораторних робіт</p>
